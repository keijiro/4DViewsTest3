// Petrifier effect custom shader
...
Shader "Petrifier"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "PetrifierGeometry.hlsl"
            #include "PetrifierFragment.hlsl"

            // Custom: Shader entry points
            #pragma vertex VertexThru
            #pragma geometry PetrifierGeometry
            #pragma fragment PetrifierFragment
